...
const currentCryptoPreset = SemanticPipelinePresetDefinitionSchema.parse({
  ...
  nodes: [
    ...
    { nodeId: "decision", role: "decision", agentTemplateId: "agent-template.decision", observationWindowIds: [], authority: "decision_intent", inputArtifactTypes: ["decision_semantic_context"], outputArtifactTypes: ["semantic_decision"] },
