...
export class MultiPaperRuntimeHttpHandler {
  constructor(private readonly authenticate: PipelineOrchestrationAuthenticator, private readonly service: MultiPaperDeploymentService, private readonly repository: SqliteMultiPaperDeploymentRepository) {}
