...
async function runDoctor(args: Args): Promise<void> {
  ...
  const traceDb = typeof args["trace-db"] === "string" ? args["trace-db"] : "data/tradeboard.db";
