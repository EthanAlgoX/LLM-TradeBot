...
const BUTTON_VARIANT_STYLES = {
  primary: 'border border-primary bg-primary text-primary-foreground shadow-[0_1px_2px_hsl(var(--primary)/0.18),0_7px_18px_hsl(var(--primary)/0.14)] hover:bg-primary/90',
  secondary: 'border border-border bg-card text-foreground shadow-[0_1px_2px_hsl(var(--foreground)/0.05)] hover:border-primary/30 hover:bg-hover',
  ...
  outline: 'border border-border bg-transparent text-foreground hover:border-primary/35 hover:bg-primary/5 hover:text-primary',
  ghost: 'border border-transparent bg-transparent text-secondary-text hover:bg-hover hover:text-foreground',
  gradient: 'border border-primary bg-primary text-primary-foreground shadow-[0_7px_18px_hsl(var(--primary)/0.14)] hover:bg-primary/90',
