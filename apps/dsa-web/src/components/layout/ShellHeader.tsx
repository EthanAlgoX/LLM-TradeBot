...
const TITLES: Record<string, { title: UiTextKey; description: UiTextKey }> = {
  ...
  '/stock-research': { title: 'layout.route.stockResearch.title', description: 'layout.route.stockResearch.description' },
  '/backtest': { title: 'layout.route.backtest.title', description: 'layout.route.backtest.description' },
  '/agents': { title: 'layout.route.agents.title', description: 'layout.route.agents.description' },
  '/strategies': { title: 'layout.route.library.title', description: 'layout.route.library.description' },
  '/strategy-development': { title: 'layout.route.strategyDevelopment.title', description: 'layout.route.strategyDevelopment.description' },
  '/data': { title: 'layout.route.dataSources.title', description: 'layout.route.dataSources.description' },
  '/backtests': { title: 'layout.route.validation.title', description: 'layout.route.validation.description' },
  '/validation': { title: 'layout.route.validation.title', description: 'layout.route.validation.description' },
  '/research': { title: 'layout.route.validation.title', description: 'layout.route.validation.description' },
  '/runs': { title: 'layout.route.runs.title', description: 'layout.route.runs.description' },
  ...
  '/simulation': { title: 'layout.route.simulation.title', description: 'layout.route.simulation.description' },
