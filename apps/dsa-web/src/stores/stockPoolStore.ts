...
export interface StockPoolState {
  ...
  submitAnalysis: (options?: SubmitAnalysisOptions) => Promise<AnalyzeAsyncResponse | null>;
  ...
  submitAnalysis: async (options) => {
    ...
    try {
      const response = await analysisApi.analyzeAsync({
        ...
        ...(options?.strategyVersionId !== undefined && { strategyVersionId: options.strategyVersionId }),
      });
