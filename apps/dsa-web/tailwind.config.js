  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'primary-gradient': 'linear-gradient(180deg, hsl(var(--primary)) 0%, hsl(var(--primary)) 100%)',
      },
      boxShadow: {
        'soft-card': 'var(--shadow-soft-card)',
        'soft-card-strong': 'var(--shadow-soft-card-strong)',
        'glow-cyan': '0 8px 22px hsl(var(--primary) / 0.16)',
        'glow-purple': '0 8px 22px hsl(var(--primary) / 0.12)',
        'glow-success': '0 8px 22px hsl(var(--success) / 0.12)',
        'glow-danger': '0 8px 22px hsl(var(--danger) / 0.12)',
        'cyan/20': '0 8px 20px hsl(var(--primary) / 0.16)',
        'cyan/22': '0 10px 24px hsl(var(--primary) / 0.18)',
      },
      borderRadius: {
        lg: 'var(--radius)',
